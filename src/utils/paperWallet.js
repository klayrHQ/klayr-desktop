...
import logo from '@setup/react/assets/images/paperWallet/klayr-logo-blue-on-white-rgb.png';
...
class PaperWallet {
  ...
  setupDoc() {
    ...
    this.doc.setTextColor(48, 48, 48).setFont('Utendo');
  }
