...
describe('Add Account Choice', () => {
  it('Should render the add account choice page', async () => {
    ...
    expect(screen.getByText('Choose an option to add your account to Klayr wallet.')).toBeTruthy();
    expect(screen.getByText('Don’t have a Klayr account yet?')).toBeTruthy();
