...
#     Then I should see staking queue details for validator "genesis_29" with amount "10 KLY"
#     And I wait for "1 seconds"
...
#     And I wait for "1 seconds"
#     Then I should see staking confirmation details with amount "10 KLY"
...
#     Then I should see "Continue staking"
#     When I click on a button with text "Go to the staking queue"
#     Then I should see staking queue details for validator "genesis_29" with amount "30 KLY"
#     And I wait for "1 seconds"
#     When I click on a button with text "Continue"
#     And I click on a button with text "Confirm"
#     When I type "Password@1" in "password"
#     And I click on a button with text "Continue"
#     Then I should see staking confirmation details with amount "20 KLY"
...
#     And I click on a button with text "Continue"
#     And I wait for "1 seconds"
#     Then I should see unstaking confirmation details with amount "30 KLY"
