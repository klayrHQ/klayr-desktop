Feature: Request Token
  Background: Add an account and navigate to wallet
    ...
    And "klayr_mainchain" should be selected in "Recipient application" dropdown
    And "Klayr" should be selected in "Token" dropdown
  ...
  Scenario: Request token should generate a copy link
    ...
    Then Clipboard should contain "klayr://send?recipient=klym9syv4wrjcjczpegz65zqxhk2cp9dkejs5wbjb&amount=10&token=0400000000000000&recipientChain=04000000"
  ...
  Scenario: Request token should generate a copy link with message
    ...
    Then Clipboard should contain "klayr://send?recipient=klym9syv4wrjcjczpegz65zqxhk2cp9dkejs5wbjb&amount=10&reference=hello&token=0400000000000000&recipientChain=04000000"
  ...
  Scenario: Request token should generate a copy link if message is within 64 characters
    ...
    And I click on a button with text "Copy link"
    Then Clipboard should contain "klayr://send?recipient=klym9syv4wrjcjczpegz65zqxhk2cp9dkejs5wbjb&amount=10&reference=hello(*%23(%40))*!%23%40%24%5E%25%23%40%40)world!%40%24%5E%23message*%40)%23*)%40%24%24%40%5E!(%40%23)~~%40test1&token=0400000000000000&recipientChain=04000000"
